import email from '@/public/svg/contacts/email.svg';
import github from '@/public/svg/contacts/github.svg';
import phone from '@/public/svg/contacts/phone.svg';
import youtube from '@/public/svg/contacts/youtube.svg';

const username = 'AndrewDongminYoo';
const myName = 'Dongmin, Yu';
...
const stacks = {
    primaryTags: ['React Native', 'Flutter', 'TS Node'],
    technicalTags: [
        ...
        'GitHub',
        'TailwindCSS',
        'Storybook (JS) / WidgetBook (Flutter)',
        'Figma / Protopie',
        'Firebase',
