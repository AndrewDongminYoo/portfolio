...
export const description = `요리사로 일하다 코로나19 시기에 독학으로 Python 웹 스크래핑을 시작하며 개발에 입문했습니다. 이후 React Native와 Java/Spring 백엔드 교육 과정, Django 백엔드를 거쳐 Flutter를 만나 크로스플랫폼 앱 개발에 정착했고, 최근에는 React Native New Architecture(TurboModule) 네이티브 모듈 개발까지 경험을 넓혔습니다.

지난 4년간 크로스플랫폼 모바일 개발자로서 주로 Flutter로 iOS/Android 앱을 기획–개발–배포–운영까지 책임져 왔습니다. 인증/딥링크/푸시/결제 같은 핵심 기능을 안정적으로 연결하고, 로그·지표를 기반으로 UX를 개선해 이탈 요인을 줄이는 일을 가장 중요하게 생각합니다.
...
export const shortDescription =
  'Flutter 크로스플랫폼 앱과 React Native 네이티브 모듈(TurboModule·New Architecture)을 만들어 온 모바일 개발자입니다. 인증·결제·딥링크 같은 핵심 기능과 개발 자동화에 강점이 있습니다.';
