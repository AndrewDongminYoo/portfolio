            ...
            <div className='flex gap-4 p-4 m-auto text-base md:gap-6 md:max-w-2xl lg:max-w-2xl xl:max-w-3xl md:py-6 lg:px-0'>
                <div className='relative flex flex-col items-end w-8'>
                    <div className='relative flex'>
                        <span
                            className='box-border relative inline-block w-auto h-auto overflow-hidden'>
                            <Image
                                alt='Andrew Yu'
                                src={profile}
                                width={32}
                    ...
                    <div className='absolute left-0 flex items-center justify-center invisible gap-1 -ml-4 text-xs -translate-x-full top-2 group-hover:visible'>
                    </div>
                </div>
