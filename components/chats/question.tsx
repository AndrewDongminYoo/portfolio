      ...
      <div className='flex p-4 m-auto text-base gap-4 md:gap-6 md:max-w-2xl lg:max-w-2xl xl:max-w-3xl md:py-6 lg:px-0'>
        <div className='relative flex flex-col items-end w-8'>
          <div className='relative flex'>
            <span className='relative inline-block w-auto h-auto overflow-hidden box-border'>
              <Image
                alt='Andrew Yu'
                src={profile}
                width={32}
                ...
                decoding='async'
                loading='lazy'
                className='inset-0 m-auto border-0 rounded-sm box-border'
              />
            </span>
          </div>
          <div className='absolute left-0 flex items-center justify-center invisible -ml-4 text-xs gap-1 -translate-x-full top-2 group-hover:visible'></div>
        </div>
